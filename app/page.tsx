...
function CollectorDemo() {
  return <div className="role-layout collector-layout">
    ...
    <div className="explanation passenger-explanation">
      ...
      <ul className="point-list">
        <li><span><Icon name="check" size={14}/></span> Indica a quantidade — o valor total é calculado antes da leitura</li>
        <li><span><Icon name="check" size={14}/></span> Lê o QR do passageiro para gerar a solicitação de débito</li>
        <li><span><Icon name="check" size={14}/></span> Recebe a confirmação instantânea no dispositivo</li>
      </ul>
    </div>
  </div>;
}
